      ...
      <ThemeProvider theme={theme}>
        ...
        <div className={classes.wrapper}>
          <Typography variant="h4" className={classes.bigSpace} color="primary">
             At Rocket.io is designed by Hritik ranjan 
          </Typography>
          <Typography variant="h5" className={classes.littleSpace} color="primary">
            This the first react website made by Hritik Ranjan using Youtube tutorials as a part of internship is Thatastu(Full Stack July Cohert)
          </Typography>
        </div>
